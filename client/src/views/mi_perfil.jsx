...
import { StyledPerfil } from './Perfil/perfil';
                ...
                <div className='div_container1'>
                    ...
                    }
                    {
                        countriesFavorites?.length > 0 ? (
                            <>
                            <h2 className='h2'>Mis paises favoritos: </h2> 
                        ...
                        ) : (<div className='div_sin_paises'><h2 className='h2_1'>No tienes paises favoritos</h2></div>)
                    }
                </div>
            </StyledPerfil>
        </>
