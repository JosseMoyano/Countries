...
import { StyledAñadirActividades } from './StyledComponents/añadir_actividades'

export default function AñadirActividad (){
    ...
    const eliminar = (e, id) => {
        e.preventDefault()
        setactividad({...actividad, idPais: actividad.idPais.filter(pais => pais !== id)})
    ...
    return (
        <StyledAñadirActividades>
            ...
            <div className='div_container1'>
                ...
                <p className='p'>Llená este formulario para añadir distintas actividades que puedan ser realizadas en los diferentes países del mundo.</p>
                <p className='p'>Todos los son campos obligatorios, es decir que para poder crear una nueva actividad debes llenar todos los campos.</p>
            </div>
            ...
            }
            {
                ok ? (
                    <div className='div_modal'>
                        ...
                        <button type='button' className='button_modal' onClick={() => history.push('/actividades/mostrar')}>Mostrar Actividades</button>
                        </div>                    
                    </div>
                ) : (null)
            }
